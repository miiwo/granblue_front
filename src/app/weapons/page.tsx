            ...
            <div className="flex flex-col gap-3 bg-nordtwo shadow-md pb-4 pt-1">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <div className='rounded overflow-x-auto'>
                        <fieldset className='flex relative gap-3 rounded-lg bg-slate-700 lg:w-3/4 text-center'>
                ...
                <div className="flex flex-row items-center">
                    ...
                    <div className='rounded-lg overflow-x-auto'>
                        <fieldset className='flex relative gap-3 rounded-lg bg-slate-700 lg:w-[85%] text-center place-items-center'>
