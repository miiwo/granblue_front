export default function Home() {
  ...
  return (
    <div className="h-screen grid grid-rows-3 justify-center">
      <div className="row-span-1 text-center mx-4 md:mx-12 pt-14 md:pt-6 lg:px-56 lg:pt-20">
      ...
      <div className="flex flex-col place-items-center row-span-2">
        ...
        <div className="flex flex-col mx-3 md:flex-row gap-4 justify-center">
          {Object.keys(latestUpdates).map((key, i) => {
            return (
              <span key={`latest_update_${i}`} className="border px-4 py-3 basis-1/3 lg:basis-none lg:w-[850px]">
                <h2>{key}</h2>
