            ...
            <h1 className="font-bold text-2xl underline underline-offset-4 text-center">Calculator</h1>
                <div className="pl-6 grid grid-cols-2 gap-x-4 me-6">
                    ...
                    <div className="col-span-2 bg-nordtwo rounded shadow-md px-3 py-3 mb-5 flex flex-col gap-3">
                        ...
                        <p>The damage formula depends on: Magna <InlineImage src={"/magna_atk_weapon_skill.png"} width={"w-[25px]"} height={"h-[25px]"} />, Normal <InlineImage src={"/normal_atk_weapon_skill.png"} width={"w-[25px]"} height={"h-[25px]"} />, and EX <InlineImage src={"/ex_atk_weapon_skill.png"} width={"w-[25px]"} height={"h-[25px]"} /> mods. Multiplying the boosts you have between them leads to greater strength! You&apos;ll be surprised when the in-game calculator reports lower power but your experience in raids is different! </p>
